...
df_filtered <- df[!df$fibe_pk_tertile %in% c("T1", "T2"), ]
...
print(permanova) # no significant difference in microbiome by secretor status (P = 0.28)
...
ggsave(filename = '/Users/yasmine.bouzid/Documents/FUT2_analysis/plots/permanova_tertileASA24high.jpg', plot = p, device = 'jpeg', dpi = 300, width = 10, height = 6, units = "in")
