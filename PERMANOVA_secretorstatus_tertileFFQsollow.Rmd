...
df_filtered <- df[!df$dt_fiber_sol_pk_tertile %in% c("T2", "T3"), ]
...
print(permanova) # no significant difference in microbiome by secretor status (P = 0.67)
...
ggsave(filename = '/Users/yasmine.bouzid/Documents/FUT2_analysis/plots/permanova_tertileFFQsollow.jpg', plot = p, device = 'jpeg', dpi = 300, width = 10, height = 6, units = "in")
